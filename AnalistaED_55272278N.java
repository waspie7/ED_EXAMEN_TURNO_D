...
public class AnalistaED_55272278N {
	...
	/**
	 * Calcula el salario bruto mensual en función del salario base por hora y las horas extras El precio por hora
	 * de la hora extra se determina con la constante FACTOR_HORA_EXTRA
	 * 
	 * @param horasExtra número de horas extra dedicadas redondeando a la baja (entero)
	 * @return devuelve el salario bruto menusal en euros con dos decimales
	 */
